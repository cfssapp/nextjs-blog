...
var renderFooter = function renderFooter(_ref) {
  ...
  if (Array.isArray(tabList) || tabBarExtraContent) {
    return (0, _jsxRuntime.jsx)(_antd.Tabs, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      ...
      children: tabList === null || tabList === void 0 ? void 0 : tabList.map(function (item, index) {
        return (0, _jsxRuntime.jsx)(_antd.Tabs.TabPane, (0, _objectSpread2.default)({
          tab: item.tab
        }, item), item.key || index);
      })
    }));
...
var ProBreadcrumb = function ProBreadcrumb(props) {
  ...
  return (0, _jsxRuntime.jsx)("div", {
    ...
    children: (0, _jsxRuntime.jsx)(_antd.Breadcrumb, (0, _objectSpread2.default)((0, _objectSpread2.default)((0, _objectSpread2.default)({}, value === null || value === void 0 ? void 0 : value.breadcrumb), value === null || value === void 0 ? void 0 : value.breadcrumbProps), props))
  });
};
...
var memoRenderPageHeader = function memoRenderPageHeader(props) {
  ...
  return (0, _jsxRuntime.jsx)(_PageHeader.PageHeader, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, pageHeaderProps), {}, {
...
var PageContainerBase = function PageContainerBase(props) {
  ...
  var loadingDom = (0, _react.useMemo)(function () {
    ...
    return spinProps.spinning ? (0, _jsxRuntime.jsx)(_PageLoading.PageLoading, (0, _objectSpread2.default)({}, spinProps)) : null;
  }, [loading]);
  var content = (0, _react.useMemo)(function () {
    return children ? (0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
      children: (0, _jsxRuntime.jsx)("div", {
        className: (0, _classnames.default)("".concat(basePageContainer, "-children-content ").concat(hashId)),
  ...
  var renderContentDom = (0, _react.useMemo)(function () {
    ...
    if (props.waterMarkProps || value.waterMarkProps) {
      ...
      return (0, _jsxRuntime.jsx)(_WaterMark.WaterMark, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, waterMarkProps), {}, {
        children: dom
      }));
    }
    return dom;
  ...
  return stylish.wrapSSR(wrapSSR((0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
    children: [(0, _jsxRuntime.jsxs)("div", {
      style: style,
      ...
      })) : pageHeaderDom, renderContentDom && (0, _jsxRuntime.jsx)(_GridContent.GridContent, {
        children: renderContentDom
      })]
    }), footer && (0, _jsxRuntime.jsx)(_FooterToolbar.FooterToolbar, (0, _objectSpread2.default)((0, _objectSpread2.default)({
...
var PageContainer = function PageContainer(props) {
  return (0, _jsxRuntime.jsx)(_proProvider.ProConfigProvider, {
    needDeps: true,
    children: (0, _jsxRuntime.jsx)(PageContainerBase, (0, _objectSpread2.default)({}, props))
  });
};
