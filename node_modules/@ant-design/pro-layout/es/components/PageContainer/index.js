...
var PageContainerBase = function PageContainerBase(props) {
  ...
  return stylish.wrapSSR(wrapSSR(_jsxs(_Fragment, {
    children: [_jsxs("div", {
      style: style,
    ...
    }), footer && _jsx(FooterToolbar, _objectSpread(_objectSpread({
...
var PageContainer = function PageContainer(props) {
  return _jsx(ProConfigProvider, {
    needDeps: true,
    children: _jsx(PageContainerBase, _objectSpread({}, props))
  });
};
